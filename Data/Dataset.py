...
class Dataset(DatasetBase):
    def __init__(self,args : dict):
        ...
        train_dataset_config = {
            ...
            "data_path":self.args["directory"]+self.args["partition"]+"/train_multi_joint_60.npy",
            "label_path":self.args["directory"]+self.args["partition"]+"/train_label_60.pkl",
        ...
        val_dataset_config = {
            ...
            "data_path":self.args["directory"]+self.args["partition"]+"/val_multi_joint_60.npy",
            "label_path":self.args["directory"]+self.args["partition"]+"/val_label_60.pkl",
            "use_mmap":self.args["use_mmap"],
            "debug":self.args["debug"],
            "downsample_rate":args["downsample_rate"]
        }
