...
class AGCNEncoder(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3, adaptive=True, attention=True): #change 3 to 64
        ...
        # self.l1 = TCN_GCN_unit(in_channels, 64, A, residual=False) #change agcn
        # # self.l1 = TCN_GCN_unit(64, 64, A, residual=False) #change  3 to 64 shift gcn
